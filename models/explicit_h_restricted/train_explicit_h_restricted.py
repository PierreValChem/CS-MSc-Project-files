"""
Training script for explicit H restricted model
Uses explicit hydrogen SMILES WITH molecule validation
"""
...
MODEL_CONFIG = {
    'model_name': 'explicit_h_restricted',
    'use_explicit_h': True,
...
if __name__ == "__main__":
    print("="*60)
    print("Training Explicit H Restricted Model with Validity Constraints")
    print("="*60)
