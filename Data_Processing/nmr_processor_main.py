#!/usr/bin/env python3
"""
Main entry point for the Enhanced NMReDATA Processor
This file handles command-line arguments and initializes the processor
"""
...
print("Enhanced NMReDATA Processor Starting...")

# Import the processor class from the module
try:
    from Data_Processing.integrated_batch_processor import IntegratedBatchProcessor
    from Data_Processing.utils import setup_logging, verify_installation
    print("✓ Imports successful")
except ImportError as e:
    print(f"✗ Import error: {e}")
    print("Make sure integrated_batch_processor.py and Data_Processing folder are in the same directory")
    sys.exit(1)
...
def main():
    """Main entry point"""
    print("="*70)
    print("Enhanced NMReDATA Batch Processor")
    print("="*70)
    
    parser = argparse.ArgumentParser(description="Enhanced NMR Data Processor")
    ...
    output_dir = args.output if args.output else os.path.join(args.base_dir, "NMR_Output_Enhanced")
    ...
    logger.info("="*70)
    logger.info("Enhanced NMReDATA Batch Processor with Smart File Selection")
    logger.info("="*70)
